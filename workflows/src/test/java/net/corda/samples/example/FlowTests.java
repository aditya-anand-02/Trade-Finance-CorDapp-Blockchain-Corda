...
//import net.corda.samples.example.flows.Flow1;
...
//        MakePayment.Initiator flow = new MakePayment.Initiator(-1, b.getInfo().getLegalIdentities().get(0));
...
//        Flow1.InitiatorA flow = new Flow1.InitiatorA(1, b.getInfo().getLegalIdentities().get(0));
//        CordaFuture<SignedTransaction> future = a.startFlow(flow);
//        network.runNetwork();
//
...
//        Integer iouValue = 1;
//        Flow1.InitiatorA flow = new Flow1.InitiatorA(iouValue, b.getInfo().getLegalIdentities().get(0));
//        CordaFuture<SignedTransaction> future = a.startFlow(flow);
//        network.runNetwork();
//        SignedTransaction signedTx = future.get();
//
